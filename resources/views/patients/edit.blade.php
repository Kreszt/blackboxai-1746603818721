        ...
        <div class="px-4 py-6 sm:p-8">
            <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div class="sm:col-span-4">
                    <label for="nomor_rm" class="block text-sm font-medium leading-6 text-gray-900">
                        Nomor RM
                    </label>
                    <div class="mt-2">
                        <input type="text" 
                               id="nomor_rm" 
                               x-model="form.nomor_rm"
                               disabled
...
function patientForm() {
    return {
        ...
        async submitForm() {
            ...
            try {
                const response = await fetch(`/api/v1/patients/${this.patientId}`, {
                    method: 'PUT',
                    headers: {
